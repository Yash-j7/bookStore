...
function Navbar() {
  ...
  const handleScrollAbout = () => {
    ...
    animateScroll.scrollTo(1300, options);
  };
  const navItems = (
    <>
      <li>
    ...
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
            ? "sticky-navbar shadow-md bg-slate-300 dark:bg-slate-700 dark:text-white duration-300 transition-all ease-in-out"
            : ""
        }`}
      >
        <div className="navbar ">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className={`"menu menu-sm dropdown-content z-[1] p-2 shadow ${
                  sticky ? "bg-slate-300 " : "bg-white"
                } rounded-box w-52"`}
              >
                {navItems}
              </ul>
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className=" px-3 py-2 border dark:border-none rounded-md flex items-center gap-2">
                <input
                  type="text"
