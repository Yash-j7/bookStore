...
function Navbar() {
    ...
    return (
        <div className={`max-w-screen-2xl z-10 container mx-auto md:px-10 px-10 fixed top-0 right-0 left-0
        ${sticky ? ' dark:bg-slate-500 sticky-navbar shadow-md bg-slate-200 transition-all ease-in-out' : ''}
        `}>
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-center hidden lg:flex">
                    ...
                    <label className="p-2 pr-5  flex rounded-xl cursor-pointer items-center gap-2">
                        <input type="text" className=" rounded-xl border p-2 outline-none grow" placeholder="Search" />
                    ...
                    <div className="">
                        <a className="rounded-2xl duration-300 bg-black text-white px-4 py-2"><button
